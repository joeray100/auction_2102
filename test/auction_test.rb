...
class AuctionTest < Minitest::Test
  ...
  def test_it_can_add_items_and_list_their_names
    # skip
  ...
  def test_starts_with_no_bids_and_can_add_bids
   item1 = Item.new('Chalkware Piggy Bank')
   item2 = Item.new('Bamboo Picture Frame')
  ...
  def test_it_can_show_highest_bid_and_unpopular_items
    item1 = Item.new('Chalkware Piggy Bank')
    item2 = Item.new('Bamboo Picture Frame')
    item3 = Item.new('Homemade Chocolate Chip Cookies')
    item4 = Item.new('2 Days Dogsitting')
    ...
    assert_equal [item2, item5, item3], auction.unpopular_items
